...
namespace CompareNumbers
{
    class CompareNumbers
    {
        static void Main(string[] args)
        {
            ...
            {
                Console.WriteLine("{0} and {1} are equal except {2}", num1, num2, num3);
            }

            else if (num1 != num2 && num1 == num3 && num2 != num3)
            {
                Console.WriteLine("{0} and {1} are equal except {2}", num1, num3, num2);
            }

            else if (num1 != num2 && num1 != num3 && num2 == num3)
            {
                Console.WriteLine("{0} and {1} are equal except {2}", num2, num3, num1);
            }
